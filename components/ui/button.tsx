...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-semibold transition-all duration-150 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 aria-invalid:ring-destructive/20 aria-invalid:border-destructive cursor-pointer select-none",
  {
    variants: {
      variant: {
        default:
          "bg-primary text-primary-foreground shadow-[3px_3px_0px_0px_var(--primary-700)] hover:-translate-y-0.5 hover:shadow-[4px_4px_0px_0px_var(--primary-700)] active:translate-y-0.5 active:shadow-[1px_1px_0px_0px_var(--primary-700)]",
        destructive:
        ...
        accent:
          "bg-accent text-accent-foreground shadow-[3px_3px_0px_0px_var(--accent-700)] hover:-translate-y-0.5 hover:shadow-[4px_4px_0px_0px_var(--accent-700)] active:translate-y-0.5 active:shadow-[1px_1px_0px_0px_var(--accent-700)]",
      },
      size: {
