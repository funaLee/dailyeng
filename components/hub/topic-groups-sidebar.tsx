          ...
          <button
            ...
            className={`w-full text-left px-3 py-2.5 rounded-md text-sm transition-colors flex items-center gap-3 cursor-pointer ${
              selectedGroup === group.name
                ? "bg-white dark:bg-slate-800 font-semibold text-blue-700 dark:text-blue-300 shadow-sm border border-blue-100 dark:border-blue-800"
          ...
          >
            <div
              className={`h-2 w-2 rounded-full flex-shrink-0 ${
                selectedGroup === group.name ? "bg-blue-500" : "bg-slate-300 dark:bg-slate-600"
              }`}
            />
