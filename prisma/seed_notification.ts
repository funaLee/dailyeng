...
async function main() {
  ...
  // Get the first user from database to assign notifications
  ...
  const notificationTemplates = [
    // NOTEBOOK notifications (15)
    {
      title: "Word Added to Notebook",
      message: "You've successfully added 'perseverance' to your vocabulary notebook.",
    ...
    },
    {
      ...
      message: "Grammar note for 'Present Perfect Tense' has been saved to your notebook.",
      type: NotificationType.notebook,
    },
    {
      title: "Notebook Backup",
      message: "Your notebook has been automatically backed up. 127 items saved.",
      type: NotificationType.notebook,
    },
    {
      title: "Word Mastered",
      message: "Great job! You've mastered the word 'eloquent' after 5 reviews.",
      type: NotificationType.notebook,
    },
    {
    ...
    },
    {
      ...
      message: "Your custom study set 'IELTS Vocabulary' is ready for practice.",
      type: NotificationType.notebook,
    },
    {
      title: "Notebook Sync",
    ...
    },
    {
      ...
      message: "Based on your progress, we recommend focusing on pronunciation.",
      type: NotificationType.plan,
    },
    {
    ...
    },
    {
      ...
      message: "You've completed 50 speaking sessions. You're a conversation pro!",
      type: NotificationType.achievement,
    },
    {
    ...
    },
    {
      ...
      message: "Scheduled maintenance on Dec 20, 2:00-4:00 AM. Service may be interrupted.",
      type: NotificationType.system,
    },
    {
      title: "Update Available",
      message: "A new version of DailyEng is available. Update now for better performance.",
      type: NotificationType.system,
    },
    {
    ...
    },
    {
      ...
      message: "Help us improve! Share your feedback about your learning experience.",
      type: NotificationType.system,
    },
    {
      title: "Community Event",
      message: "Join our live English conversation session this Saturday at 3 PM!",
      type: NotificationType.system,
    },
    {
      title: "Special Offer",
  ...
  // Create notifications with varying timestamps and read status
  const notifications = [];
  const now = new Date();
  ...
  for (let i = 0; i < notificationTemplates.length; i++) {
    ...
    // Mark older notifications as read (50% chance for notifications older than 24 hours)
    const isOlderThan24Hours = hoursAgo > 24;
    const isRead = isOlderThan24Hours ? Math.random() > 0.5 : false;
  ...
  console.log(`\n📬 Unread: ${unreadCount} | Read: ${result.count - unreadCount}`);
}
