...
export default function SpeakingSessionPage() {
  ...
  const calculateStats = (allTurns: Turn[]) => {
    ...
    if (allScores.length > 0) {
      const avgPronunciation =
        allScores.reduce((sum, t) => sum + (t.scores?.pronunciation || 0), 0) /
        allScores.length;
      const avgFluency =
            ...
            <div>
              ...
              <div className="space-y-3">
                <div className="flex gap-3 p-4 bg-primary-50 rounded-xl">
                  ...
                  <p className="text-sm">
                    Talk about being tired of a small room.
                  </p>
                </div>
                <div className="flex gap-3 p-4 bg-primary-50 rounded-xl">
                  <div className="flex-shrink-0 w-8 h-8 rounded-full bg-primary-500 text-white flex items-center justify-center font-bold">
                ...
                <div className="flex gap-3 p-4 bg-primary-50 rounded-xl">
                  ...
                  <p className="text-sm">
                    Compare and talk about two types of houses.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="space-y-4 p-4 bg-primary-50 rounded-xl text-sm">
                <div>
                  <p className="font-medium mb-1">
                    1. One day, I'm going to have a house with a pool, a walk-in
                    closet, and a huge kitchen.
                  </p>
                  <p className="text-muted-foreground italic">
                    Một ngày nào đó, tôi sẽ có một căn nhà với hồ bơi, tủ đồ cỡ
                    mà có thể bước vào được, và một căn bếp rất mà rất lớn.
                  </p>
                </div>
                <div>
                  <p className="font-medium mb-1">
                    2. Don't forget the home theater! I'll invite you over for
                    movie nights every weekend.
                  </p>
                  <p className="text-muted-foreground italic">
                    Đừng quên rạp chiếu phim tại nhà nhé! Tớ sẽ mời cậu tới xem
                    phim mỗi cuối tuần.
                  </p>
                </div>
                <div>
                  <p className="font-medium mb-1">
                    3. Sounds perfect … now if only our bank accounts would
                    agree.
                  </p>
                  <p className="text-muted-foreground italic">
                    Nghe hoàn hảo đây … giá mà tài khoản ngân hàng của chúng ta
                    cũng đồng ý.
                  </p>
                </div>
              </div>
          ...
          <div className="space-y-6">
            <Card className="p-8">
              ...
              <h1 className="text-3xl font-bold mb-4">
                {scenario.title || "Share about your dream house"}
              </h1>

              <p className="text-muted-foreground mb-6 leading-relaxed">
                In their shabby little room, A dreams of a mansion with
                countless rooms — for gaming, movies, and spa. B dreams of a
                cozy home surrounded by flowers and butterflies. While they are
                arguing, the power suddenly goes out, and the sounds of
                neighbors complaining bring them both back to reality.
              </p>
          ...
          <div className="rounded-2xl border bg-card p-8 col-span-2">
            ...
            <div className="mb-6">
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">
                In a shabby room, A dreams of a mansion with countless rooms: a
                game room, a cinema room, and a spa. B dreams of a cottage
                surrounded by flowers and butterflies. While they are arguing,
                the power suddenly goes out, and the sounds of neighbors
                complaining bring them both back to reality.
              </p>
            </div>
            ...
            <div className="space-y-4 mb-8 min-h-[300px]">
              ...
              {turns.length === 0 && (
                <div className="text-center py-12 text-muted-foreground">
                  ...
                  <p className="text-sm">
                    Tap the microphone button below to begin
                  </p>
                </div>
              )}
            </div>
  ...
  if (viewState === "complete") {
    ...
    const radarData = [
      ...
      {
        label: "Pronunciation",
        value: Math.round(sessionStats.avgPronunciation * 10),
      },
      {
        label: "Intonation & Stress",
        value: Math.round(sessionStats.avgFluency * 0.8 * 10),
      },
          ...
          <div className="space-y-8">
            ...
            <Card className="p-8 bg-gradient-to-br from-gray-50 to-gray-100">
              <h2 className="text-3xl font-bold mb-4">
                Amazing context understanding
              </h2>
              <p className="text-base text-muted-foreground leading-relaxed">
                Amazing work! You seem to understand the context really well,
                you also got nice pronunciation and good use of grammar.
                However, you may want to put in more time in speaking session to
                improve your fluency, since there are a couple of times you
                pause a bit too long to remember the pronunciation of a word.
              </p>
            </Card>
          </div>
              ...
              <div>
                ...
                <div className="w-full bg-secondary rounded-full h-2">
                  <div
                    ...
                    style={{
                      width: `${(sessionStats.avgPronunciation / 10) * 100}%`,
                    }}
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="w-full bg-secondary rounded-full h-2">
                  <div
                    className="bg-blue-500 h-2 rounded-full"
                    style={{
                      width: `${(sessionStats.avgFluency / 10) * 100}%`,
                    }}
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="w-full bg-secondary rounded-full h-2">
                  <div
                    ...
                    style={{
                      width: `${(sessionStats.avgGrammar / 10) * 100}%`,
                    }}
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="w-full bg-secondary rounded-full h-2">
                  <div
                    ...
                    style={{
                      width: `${(sessionStats.avgContent / 10) * 100}%`,
                    }}
                  />
                </div>
              </div>
