            ...
            <Card className="border-border shadow-sm">
              <CardContent className="p-6">
                ...
                <p className="text-sm text-muted-foreground">
                  Organize and track your learning materials across vocabulary,
                  grammar, and speaking topics
                </p>
              </CardContent>
            </Card>
              ...
              {collections.map((collection) => (
                ...
                >
                  <div className="relative aspect-video bg-muted">
                    ...
                    <Badge
                      className={`absolute top-3 left-3 border ${getDifficultyColor(
                    ...
                    >
                      <Bookmark
                        className={`h-4 w-4 ${
                          collection.isSaved ? "fill-current" : ""
                        }`}
                      />
                    </button>
                  </div>
