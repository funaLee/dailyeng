...
export default function StudyPlanPage() {
  ...
  const selectedPlan =
    studyPlans.find((p) => p.id === selectedPlanId) || studyPlans[0];
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12">
        <div className="space-y-8">
          ...
          <HubHero
            ...
            notification={{
              text: "You have 2 lessons to complete today",
              actionLabel: "Learning now",
            }}
                    ...
                    <div className="border-r border-primary-50 p-1">
                      <div
                        className={`w-full h-full rounded-lg ${
                          isEditing
                            ? "animate-pulse ring-1 ring-primary-300"
                            : ""
                        } bg-primary-200 text-primary-900 font-medium flex items-center justify-center text-[10px] shadow-sm`}
                      >
                        Speaking
                      </div>
                    </div>
            ...
            <Card className="p-6 border-primary-200 shadow-md lg:col-span-2">
              ...
              <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
                ...
                <div className="md:col-span-3 space-y-6">
                  ...
                  <div className="bg-gradient-to-br from-primary-50 to-primary-100 rounded-xl p-4 text-center space-y-2 border border-primary-200">
                    ...
                    <p className="text-[10px] text-slate-500">
                      Kết thúc lúc 11:59PM ngày 23/11/2025
                    </p>
                  </div>
                </div>
                ...
                <div className="md:col-span-5">
                  <h3 className="font-bold mb-4 text-slate-800 capitalize">
                    {activeMissionTab} Mission
                  </h3>
                ...
                <div className="md:col-span-4 flex flex-col items-center justify-center">
                  <div className="bg-gradient-to-br from-primary-100 to-primary-200 rounded-2xl p-6 text-center w-full">
                    ...
                    <Button
                      ...
                      disabled={
                        completedMissions.length < displayedMissions.length
                      }
                    >
                      Claim Gift
                    </Button>
            ...
            <Card className="p-6 border-primary-100 shadow-md flex flex-col lg:col-span-1">
              ...
              <div className="space-y-4 flex-1">
                <div className="border border-primary-100 bg-primary-50/30 rounded-xl p-4 text-center space-y-3">
                  ...
                  <h3 className="font-bold text-sm text-primary-900">
                    Speaking Room
                  </h3>
                  <p className="text-xs text-slate-500 px-4">
                    You have not practiced speaking today
                  </p>
                  <Button
                    asChild
                    variant="default"
                ...
                <div className="border border-secondary-100 bg-secondary-50/30 rounded-xl p-4 text-center space-y-3">
                  ...
                  <h3 className="font-bold text-sm text-secondary-900">
                    Notebook
                  </h3>
                  <p className="text-xs text-slate-500 px-4">
                    You have 34 words on reviewing
                  </p>
                  <Button
                    asChild
                    variant="secondary"
                ...
                {studyPlans.map((plan) => (
                  ...
                  >
                    ...
                    <div className="space-y-1">
                      ...
                      <Progress
                        value={plan.progress}
                        className="h-1.5 bg-primary-100"
                      />
                      <p className="text-[10px] text-slate-400 mt-1">
                        Remain: {plan.remainHours}h to complete
                      </p>
                    </div>
                  </div>
                ))}
