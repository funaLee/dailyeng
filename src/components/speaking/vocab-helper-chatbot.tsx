...
export default function VocabHelperChatbot() {
  ...
  const generateResponse = (query: string): string => {
    ...
    if (lowerQuery.includes("how to say") || lowerQuery.includes("how do i say")) {
    ...
    if (lowerQuery.includes("meaning") || lowerQuery.includes("what does") || lowerQuery.includes("define")) {
