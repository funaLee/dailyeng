...
import { AlertCircle, BookOpen, GraduationCap, Languages, Sparkles, ArrowRight } from "lucide-react"
...
export default function SignInPageClient({ stats, demoCredentials }: SignInPageClientProps) {
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center px-6 py-12 bg-gradient-to-b from-background to-primary-50/30">
        <div className="w-full max-w-md">
          ...
          <Card className="p-8 border-2 border-primary-100 rounded-3xl shadow-xl shadow-primary-100/20 bg-white">
            ...
            {/* Demo credentials */}
            <div className="mt-6 p-4 rounded-xl bg-accent-50 border border-accent-200">
              <p className="font-semibold text-accent-700 mb-2 flex items-center gap-2">
                <Sparkles className="h-4 w-4" />
                Demo Credentials
              </p>
              <p className="text-sm text-accent-600">Email: {demoCredentials.email}</p>
              <p className="text-sm text-accent-600">Password: {demoCredentials.password}</p>
            </div>
          </Card>
