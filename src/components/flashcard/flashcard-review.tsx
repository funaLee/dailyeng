    ...
    <div className="space-y-6">
      ...
      >
        ...
        >
          <div className="space-y-4">
            <p className="text-xs font-semibold text-muted-foreground uppercase">{isFlipped ? "Answer" : "Question"}</p>
            <p className="text-3xl font-bold">{isFlipped ? current.back : current.front}</p>
            <p className="text-sm text-muted-foreground">Click to {isFlipped ? "see question" : "reveal answer"}</p>
      ...
      {!isFlipped && (
        <div className="text-center">
          <Button variant="outline" className="gap-2 bg-transparent" onClick={() => setIsFlipped(true)}>
