...
import { X, Send, Sparkles, BookOpen, Lightbulb, HelpCircle } from "lucide-react"
      ...
      >
        ...
        <div className="relative">
          <svg viewBox="0 0 24 24" className="h-8 w-8" fill="currentColor">
            ...
            {/* Mouth */}
            <path d="M10 18 Q12 19.5 14 18" fill="none" stroke="white" strokeWidth="0.5" />
          </svg>
          {/* Sparkle indicator */}
      ...
      {kittyOpen && (
        <div className="fixed bottom-28 right-6 z-50 w-[420px] max-w-[calc(100vw-24px)] rounded-3xl bg-background border-[1.4px] border-primary-200 shadow-[6px_6px_0px_0px_rgba(var(--primary-200))] flex flex-col h-[520px] overflow-hidden">
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="h-12 w-12 rounded-full bg-white/20 backdrop-blur-sm border-2 border-white/30 flex items-center justify-center">
                  <svg viewBox="0 0 24 24" className="h-7 w-7 text-white" fill="currentColor">
                    ...
                    <path d="M20 4 L17 10 L20 10 Z" />
                    <circle cx="12" cy="14" r="8" />
                    <circle cx="9" cy="13" r="1.5" fill="currentColor" className="text-primary-500" />
                    <circle cx="15" cy="13" r="1.5" fill="currentColor" className="text-primary-500" />
                    <circle cx="9" cy="13" r="0.5" fill="white" />
                    <circle cx="15" cy="13" r="0.5" fill="white" />
                    <path d="M12 15.5 L11 17 L13 17 Z" className="text-primary-500" fill="currentColor" />
                  </svg>
                </div>
                <div>
                  ...
                  <p className="text-sm text-white/80">Your AI English learning companion</p>
                </div>
              </div>
              <Button
                variant="ghost"
              ...
              <div key={msg.id} className={`flex ${msg.role === "user" ? "justify-end" : "justify-start"}`}>
                {msg.role === "tutor" && (
                  <div className="h-8 w-8 rounded-full bg-primary-100 border border-primary-200 flex items-center justify-center mr-2 flex-shrink-0">
                    <svg viewBox="0 0 24 24" className="h-5 w-5 text-primary-500" fill="currentColor">
                      <path d="M4 4 L7 10 L4 10 Z" />
                      <path d="M20 4 L17 10 L20 10 Z" />
                      <circle cx="12" cy="14" r="8" />
                    </svg>
          ...
          <div className="border-t border-primary-100 bg-white p-4">
            ...
            <p className="text-xs text-muted-foreground mt-2 text-center">Powered by AI - Your learning companion</p>
          </div>
        </div>
      )}
    </>
