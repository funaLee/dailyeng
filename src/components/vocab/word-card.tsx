      ...
      <div className="space-y-4">
        ...
        <div className="flex items-start justify-between">
          <div className="flex-1">
            ...
            <p className="text-xs text-muted-foreground mt-1 italic">{word.partOfSpeech}</p>
          </div>
          <Button variant="ghost" size="icon" onClick={handleSpeak} aria-label="Pronounce word">
        ...
        <div className="space-y-2">
          <div>
            <p className="text-xs font-semibold text-muted-foreground uppercase">English</p>
            <p className="text-sm">{word.meaning}</p>
          </div>
          <div>
            <p className="text-xs font-semibold text-muted-foreground uppercase">Vietnamese</p>
        ...
        {word.collocations.length > 0 && (
          <div>
            <p className="text-xs font-semibold text-muted-foreground uppercase mb-2">Collocations</p>
        ...
        {/* Action Button */}
        <Button variant={saved ? "default" : "outline"} className="w-full gap-2" onClick={handleAddFlashcard}>
