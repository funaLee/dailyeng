...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-white font-sans selection:bg-[#C2E2FA] selection:text-primary-900">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            ...
            <div className="pointer-events-none flex flex-col items-center lg:items-start text-center lg:text-left">
              ...
              <RevealOnScroll delay={100}>
                {/* Updated Title: Plain primary "Eng" */}
            ...
            >
              <div className="absolute -inset-4 bg-gradient-to-r from-primary-100 to-purple-100 rounded-full opacity-30 blur-3xl -z-10" />
      ...
      <section className="py-24 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-6">
            {/* Rating Card */}
            <RevealOnScroll>
              <Card className="bg-primary-400 text-white border-0 p-6 shadow-xl rounded-2xl relative overflow-hidden group transition-transform hover:scale-[1.02] h-full cursor-pointer">
            ...
            {/* Quote Card */}
            <RevealOnScroll delay={200}>
              <Card className="bg-slate-50 border border-slate-200 p-6 shadow-lg rounded-2xl relative flex flex-col justify-center group hover:border-primary-200 transition-colors h-full cursor-pointer">
                ...
                <div className="relative z-10">
                  ...
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 bg-gradient-to-br from-primary-500 to-purple-600 rounded-full flex items-center justify-center text-white text-sm font-bold shadow-md">
                      TT
                    </div>
                    <div>
                      <div className="font-bold text-gray-900 text-sm">Thanh Truc</div>
                      <div className="text-primary-400 text-xs font-medium">Software Engineer</div>
                    </div>
                  </div>
                </div>
              </Card>
            ...
            <RevealOnScroll className="md:col-span-2">
              <Card className="h-full bg-white border border-gray-100 shadow-sm hover:shadow-md transition-all p-8 rounded-3xl flex flex-col md:flex-row items-center gap-8 overflow-hidden group cursor-pointer">
                <div className="flex-1 z-10">
                  <div className="w-12 h-12 bg-primary-100 text-primary-400 rounded-2xl flex items-center justify-center mb-6">
            ...
            <div className="lg:w-1/3 flex flex-col gap-3">
              {featureTabs.map((tab) => (
                ...
                >
                  ...
                  <div>
                    <h3 className={`font-semibold text-lg ${activeTab === tab.id ? "text-primary-900" : "text-gray-700"}`}>
                      {tab.label}
                    </h3>
                    {activeTab === tab.id && (
                      <p className="text-sm text-primary-400 mt-1 font-medium animate-fade-in">Active Feature</p>
                    )}
                  </div>
                  ...
                  >
                    <div className="relative h-64 w-full overflow-hidden rounded-t-[2rem]">
                      ...
                      <div className="absolute bottom-6 left-8 z-20">
                        <div className="inline-block bg-primary-400 text-white text-xs font-bold px-3 py-1 rounded-full mb-2">
                          FEATURE
                        </div>
          ...
          >
            ...
            <div className="space-y-6 animate-scroll-down hover:[animation-play-state:paused] hidden md:block">
              {[...reviews.reverse(), ...reviews].map((review, idx) => (
                ...
                >
                  <div className="flex items-center gap-3 mb-4">
                    <div className="w-10 h-10 rounded-full bg-primary-50 text-primary-400 flex items-center justify-center font-bold text-sm">
                      {review.name.charAt(0)}
                    </div>
                    <div>
                      <p className="font-semibold text-sm text-gray-900">{review.name}</p>
                      <p className="text-xs text-primary-400 bg-primary-50 px-2 py-0.5 rounded-full inline-block">
                        Verified Student
                      </p>
                    </div>
                  </div>
      ...
      <Dialog open={showReviewsDialog} onOpenChange={setShowReviewsDialog}>
        <DialogContent className="!max-w-[1400px] w-[95vw] max-h-[90vh] overflow-y-auto p-0">
          <div className="relative">
                ...
                {reviews.map((_, idx) => (
                  <Button3D
                    ...
                    className={`h-2.5 rounded-full transition-all cursor-pointer ${
                      idx === currentReviewIndex ? "bg-primary-500 w-8" : "bg-slate-300 hover:bg-slate-400 w-2.5"
                    }`}
                  />
                ))}
              </div>
            ...
            {/* Current Review Card */}
            <div className="p-10">
              <div className="bg-gradient-to-br from-primary-50 to-slate-50 dark:from-slate-800 dark:to-slate-900 rounded-3xl p-10">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <div className="flex-1 mx-4">
                          <div className="h-2 bg-slate-200 dark:bg-slate-700 rounded-full relative">
                            <div
                              className="absolute inset-y-0 left-0 bg-gradient-to-r from-slate-400 to-primary-500 rounded-full"
                              style={{ width: "100%" }}
                            />
                        ...
                        <div className="text-center">
                          ...
                          <p className="text-2xl font-bold text-primary-500">{reviews[currentReviewIndex].result.score}</p>
                        </div>
                      </div>
                    ...
                    <div>
                      ...
                      <div className="flex flex-wrap gap-2">
                        {reviews[currentReviewIndex].courses.map((course, idx) => (
                          <span
                            key={idx}
                            className="bg-primary-100 dark:bg-primary-900/50 text-primary-700 dark:text-primary-300 px-4 py-2 rounded-full text-sm font-medium"
                          >
                            {course}
                          </span>
                        ))}
      ...
      <section className="py-24 bg-gradient-to-br from-primary-50 via-white to-sky-50 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900 relative overflow-hidden">
        {/* Background decorations */}
        <div className="absolute top-0 right-0 w-96 h-96 bg-gradient-to-br from-primary-200/30 to-sky-200/30 dark:from-primary-900/20 dark:to-sky-900/20 rounded-full blur-3xl -translate-y-1/2 translate-x-1/2" />
        <div className="absolute bottom-0 left-0 w-80 h-80 bg-gradient-to-tr from-primary-200/30 to-indigo-200/30 dark:from-primary-900/20 dark:to-indigo-900/20 rounded-full blur-3xl translate-y-1/2 -translate-x-1/2" />

        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            {/* Left Content */}
            <div className="space-y-6">
              <div className="inline-flex items-center gap-2 bg-primary-100 dark:bg-primary-900/30 text-primary-700 dark:text-primary-300 px-4 py-2 rounded-full text-sm font-medium cursor-pointer">
              ...
              <h2 className="text-4xl md:text-5xl font-bold text-slate-900 dark:text-white leading-tight">
                Build Your
                <span className="block text-transparent bg-clip-text bg-gradient-to-r from-primary-500 to-sky-500">
                  Study Plan
                </span>
              </h2>
            ...
            {/* Right Visual */}
            <div className="relative">
              <div className="bg-white dark:bg-slate-800 rounded-3xl p-8 shadow-2xl border border-primary-100 dark:border-slate-700">
                            ...
                            <div className="flex items-center gap-3">
                              <div
                                className={`w-5 h-5 rounded-full border-2 flex items-center justify-center ${
                                  idx === 0 ? "border-primary-500 bg-primary-500" : "border-slate-300 dark:border-slate-500"
                                }`}
                              >
        ...
        <RevealOnScroll className="max-w-4xl mx-auto text-center px-4 relative z-10">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/auth/signup" className="cursor-pointer">
              <Button3D
                size="lg"
                className="bg-white text-primary-400 hover:bg-primary-50 rounded-full px-10 py-7 text-lg font-bold shadow-xl hover:shadow-2xl transition-all hover:-translate-y-1 w-full sm:w-auto cursor-pointer"
              >
            ...
            <Link href="/placement-test" className="cursor-pointer">
              <Button3D
                size="lg"
                variant="primary"
                className="border-2 border-primary-400 text-white hover:bg-primary-700/50 hover:border-primary-300 bg-transparent rounded-full px-10 py-7 text-lg font-semibold w-full sm:w-auto cursor-pointer"
              >
                Take Placement Test
              </Button3D>
            </Link>
