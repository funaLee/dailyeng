...
const questions: Question[] = [
  ...
  },
  {
    ...
    multiSelect: true,
    options: [
      { id: "ielts", value: "ielts", label: "IELTS", description: "International English Language Testing System" },
      { id: "toefl", value: "toefl", label: "TOEFL", description: "Test of English as a Foreign Language" },
      { id: "toeic", value: "toeic", label: "TOEIC", description: "Test of English for International Communication" },
      {
        id: "cambridge",
        value: "cambridge",
      ...
      { id: "none", value: "none", label: "No specific exam", description: "I'm not preparing for any exam" },
    ],
  },
  {
    id: 3,
  ...
  },
  {
    ...
    options: [
      { id: "1month", value: "1month", label: "Within 1 month", description: "Urgent deadline approaching" },
      { id: "3months", value: "3months", label: "Within 3 months", description: "Short-term goal" },
      { id: "6months", value: "6months", label: "Within 6 months", description: "Medium-term planning" },
      { id: "1year", value: "1year", label: "Within 1 year", description: "Long-term commitment" },
      { id: "flexible", value: "flexible", label: "No specific deadline", description: "Learning at my own pace" },
    ],
  },
  {
    id: 5,
  ...
  },
  {
    ...
    multiSelect: true,
    options: [
      { id: "video", value: "video", label: "Video Lessons", description: "Watch and learn from instructors" },
      {
        id: "interactive",
        value: "interactive",
      ...
      { id: "reading", value: "reading", label: "Reading Materials", description: "Articles, stories, and texts" },
      {
        id: "flashcards",
        value: "flashcards",
  ...
  },
  {
    ...
    multiSelect: true,
    options: [
      { id: "tech", value: "tech", label: "Technology & Innovation", description: "AI, startups, digital trends" },
      {
        id: "business",
        value: "business",
      ...
      { id: "science", value: "science", label: "Science & Nature", description: "Environment, health, discoveries" },
      { id: "culture", value: "culture", label: "Culture & Arts", description: "Movies, music, literature" },
      { id: "sports", value: "sports", label: "Sports & Fitness", description: "Athletics, wellness, competitions" },
      { id: "travel", value: "travel", label: "Travel & Lifestyle", description: "Food, fashion, destinations" },
    ],
  },
  {
    id: 9,
    ...
    options: [
      ...
      { id: "vocabulary", value: "vocabulary", label: "Remembering Vocabulary", description: "Words don't stick" },
      { id: "grammar", value: "grammar", label: "Understanding Grammar", description: "Rules are confusing" },
      {
        id: "listening",
        value: "listening",
      ...
      { id: "time", value: "time", label: "Finding Time", description: "Busy schedule" },
    ],
  },
  {
    id: 10,
    ...
    options: [
      ...
      { id: "community", value: "community", label: "Community & Competition", description: "Learning with others" },
      {
        id: "practical",
        value: "practical",
      ...
      { id: "goals", value: "goals", label: "Clear Goals", description: "Working towards specific targets" },
      { id: "fun", value: "fun", label: "Fun & Engaging Content", description: "Enjoying the learning process" },
    ],
  },
]
...
const allCourses: Course[] = [
  {
    ...
    description: "Comprehensive IELTS preparation covering all four skills with practice tests and expert strategies.",
    duration: "12 weeks",
  ...
  },
  {
    ...
    description: "Master the TOEIC test with focused practice on Listening and Reading sections.",
    duration: "8 weeks",
    level: "Intermediate",
    category: "Exam Prep",
  ...
  },
  {
    ...
    description: "Professional communication skills for the workplace including meetings, presentations, and emails.",
    duration: "10 weeks",
    level: "Intermediate - Advanced",
    category: "Business",
  ...
  },
  {
    ...
    description: "Overcome speaking anxiety and develop fluency through AI conversation practice.",
    duration: "6 weeks",
    level: "All Levels",
    category: "Speaking",
  ...
  },
  {
    ...
    description: "Master academic essay writing, research papers, and formal writing conventions.",
    duration: "8 weeks",
    level: "Intermediate - Advanced",
    category: "Academic",
  ...
  },
  {
    ...
    description: "Expand your vocabulary with spaced repetition and contextual learning.",
    duration: "Ongoing",
    level: "All Levels",
    category: "Vocabulary",
  ...
  },
  {
    ...
    description: "Build a solid grammar foundation from basic to advanced structures.",
    duration: "10 weeks",
  ...
  },
  {
    ...
    description: "Understand native speakers with diverse accents through authentic materials.",
    duration: "8 weeks",
    level: "Intermediate",
    category: "Listening",
  ...
  },
  {
    ...
    description: "Complete preparation for the TOEFL iBT test with strategies and practice.",
    duration: "10 weeks",
    level: "Intermediate - Advanced",
    category: "Exam Prep",
  ...
  },
  {
    ...
    description: "Practice everyday conversations with AI tutors on various topics.",
    duration: "Ongoing",
    level: "All Levels",
    category: "Speaking",
  ...
  },
  {
    ...
    description: "Improve reading speed while maintaining comprehension with diverse texts.",
    duration: "6 weeks",
    level: "Intermediate",
    category: "Reading",
  ...
  },
  {
    ...
    description: "Master English pronunciation with AI-powered feedback and practice.",
    duration: "6 weeks",
    level: "All Levels",
    category: "Speaking",
...
export default function BuildPlanPage() {
  const [stage, setStage] = useState<"intro" | "questions" | "results">("intro") // Renamed from currentStep to stage
  ...
  if (stage === "questions") {
    ...
    const generateRecommendations = () => {
      ...
      const scoredCourses = allCourses.map((course) => {
        ...
        const calculatedMatchScore = Math.min(Math.round((score / 200) * 100), 100) // Normalize score to a percentage, max 200 points

        return { ...course, matchScore: score, match: calculatedMatchScore, recommended: calculatedMatchScore >= 60 } // Changed threshold to 60%
      })
