        ...
        <div className="relative z-10 flex flex-col justify-center px-12 text-white">
          ...
          <div className="flex gap-8">
            ...
            <div>
              ...
              <p className="text-white/70">Lessons</p>
            </div>
            <div>
        ...
        <div className="w-full max-w-md">
          ...
          <Card className="p-8 border-2 border-primary-100 rounded-3xl shadow-xl shadow-primary-100/20">
            ...
            <div className="mt-6 p-4 rounded-xl bg-accent-50 border border-accent-200">
              ...
              <p className="text-sm text-accent-600">Email: demo@example.com</p>
              <p className="text-sm text-accent-600">Password: password</p>
            </div>
          </Card>
