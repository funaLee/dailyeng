...
// Assuming this is your custom component wrapper for Recharts
...
export default function SpeakingRoomPage() {
  ...
  return (
    ...
    >
      {/* FIXED: Removed 'flex' which was forcing row layout. 
        Added 'flex-col' and 'space-y-8' for correct vertical stacking.
      */}
        ...
        <div className="flex flex-col sm:flex-row gap-4 sm:gap-8 border-b border-gray-200 pb-0">
          <div className="flex gap-8 overflow-x-auto pb-px">
            <button
              ...
              className={`pb-3 px-2 text-lg font-bold transition-colors border-b-2 whitespace-nowrap ${
                activeTab === "available"
              ...
              <div className="max-w-5xl mx-auto">
                <div className="text-center mb-12">
                  ...
                  <p className="text-slate-500 max-w-2xl mx-auto">
                    Customize your learning experience by creating unique role-play scenarios or let AI surprise you with
                    a random topic tailored to your level.
                  </p>
                </div>
                ...
                <div className="grid lg:grid-cols-12 gap-8 mb-16">
                  ...
                  <div className="lg:col-span-5 space-y-8">
                    <div>
                      ...
                      <div className="relative p-4 rounded-3xl border border-slate-200 bg-white shadow-sm flex justify-center">
                        

[Image of radar chart visualization]
